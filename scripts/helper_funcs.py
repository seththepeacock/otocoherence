...
def get_human_peak_freqs(wf_fn):
    match wf_fn:
        ...
        case "human_RRrearSOAEwf1short":
            mag_freqs = [2.14, 3.26, 3.73, 4.17, 4.41, 5.56, 6.47, 7.66, 11.72]
            C_freqs = [
                1.680,
                2.139,
                2.468,
        ...
        case "human_FMlearSOAEwfA01":
            mag_freqs = [0.30, 1.55, 1.72, 2.02, 2.24, 2.76, 3.04, 3.17, 4.01]
            C_freqs = [
                0.308,
                0.349,
                0.575,
        ...
        case "human_JBrearSOAEwf2short":
            mag_freqs = [1.23, 1.45, 1.7, 1.97, 3.56, 4.06, 7.28]
            C_freqs = [
                0.604,
                0.732,
                0.790,
        ...
        case "human_LSrearSOAEwf1short":
            mag_freqs = [0.73, 0.99, 1.29, 1.64, 2.21, 3.12]
            C_freqs = [
                0.288,
                0.734,
                0.993,
